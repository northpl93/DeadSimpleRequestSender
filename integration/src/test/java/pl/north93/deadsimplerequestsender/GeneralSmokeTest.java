...
public class GeneralSmokeTest
{
    @Test
    public void generalSmokeTest(final IntegrationTestJobHelper integrationTestJobHelper)
    {
        // GIVEN
        stubFor(get("/test").willReturn(ok()));

        // WHEN
        final UUID jobId = integrationTestJobHelper.submitJob("src/test/resources/Random10000.yaml");
